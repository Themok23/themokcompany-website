...
export const clientLogos: readonly ClientLogo[] = [
  { id: "raya-cx", name: "Raya CX", industry: "Business Services", featured: true },
  { id: "turbo", name: "Turbo", industry: "Automotive", featured: true },
  { id: "wiki-food", name: "Wiki Food", industry: "Food Tech", featured: true },
  { id: "al-nasser", name: "Al Nasser", industry: "Retail", featured: true },
  { id: "raya-holding", name: "Raya Holding", industry: "Diversified", featured: true },
  { id: "taggz", name: "Taggz", industry: "Social Commerce", featured: true },
  { id: "luxury-retail", name: "Premium Retail Group", industry: "Luxury Retail", featured: false },
  { id: "fintech-partner", name: "Regional Fintech", industry: "Finance", featured: false },
  { id: "logistics", name: "Regional Logistics", industry: "Logistics", featured: false },
  { id: "healthcare", name: "Healthcare Provider Network", industry: "Healthcare", featured: false },
] as const;
